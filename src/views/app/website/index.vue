...
<div>
 <div class="col-12">
   ...
   <div>
    <b-modal id="modal-2" title="เพิ่มรายการ">
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-8">
            <input type="text"  disable="disable" class="form-control" id="page"  >
        </div>
      </div>

     <div class="form-group row">
          <label for="bill" class="col-sm-3 col-form-label">จำนวนบิล:</label>
          <div class="col-sm-8">
              <input type="text"  disable="disable" class="form-control" id="bill"  >
          </div>
      </div>

      <div class="form-group row">
          <label for="goods" class="col-sm-3 col-form-label">จำนวนสินค้า:</label>
          <div class="col-sm-8">
              <input type="text"  disable="disable" class="form-control" id="goods"  >
          </div>
      </div>

      <div class="form-group row">
          <label for="tel" class="col-sm-3 col-form-label">เวอร์ชั่น:</label>
          <div class="col-sm-8">
              <input type="text"  disable="disable" class="form-control" id="tel"  >
          </div>
      </div>
       ...
       <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text"  disable="disable" class="form-control" id="dropship"  >
                </div>
              </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text"  disable="disable" class="form-control" id="ecommerce"  >
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text"  disable="disable" class="form-control" id="affiliate"  >
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text"  disable="disable" class="form-control" id="mlm"  >
                </div>
              </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text"  disable="disable" class="form-control" id="pos"  >
                </div>
              </div>
             ...
             <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text"  disable="disable" class="form-control" id="linebroadcast"  >
                </div>
              </div>
             ...
             <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text"  disable="disable" class="form-control" id="marketplace"  >
                </div>
              </div>
    </b-modal>
  </div>
  ...
  <div>
    <b-modal id="modal-1" ref="my-modal" title="ชื่อร้าน:">
        <div class="form-group row">
          <label for="domain"  class="col-sm-3 col-form-label">Domain:</label>
          <div class="col-sm-8">
            ...
            <tbody>
              <tr>
               <tr v-for="item in resultQuery" :key="item.site_id" >
                ...
                <td><div class="mb-4">                              
                   <b-button  @click="editdata(item)" >รายละเอียด</b-button>
                     <button type="button" class="btn btn-primary btn-sm mb-1">Delete</button>
                 </div></td>          
              </tr>
